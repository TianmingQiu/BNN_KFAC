...
for j,x_j in enumerate(x_):
    ...
    std.append(torch.abs(J @ kernel_inv @ J.t()) ** 0.5 + sigma)
...
plt.savefig(result_path+'kernel.png', format='png', bbox_inches = 'tight')
#plt.savefig(result_path+'kernel.eps', format='eps', bbox_inches = 'tight')
